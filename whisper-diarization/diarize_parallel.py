...
if args.stemming:
    ...
    return_code = os.system(
        f'python3 -m demucs.separate -n htdemucs --two-stems=vocals "{args.audio}" -o "whisper-diarization/temp_outputs"'
    )
    ...
    if return_code != 0:
        ...
        vocal_target = os.path.join(
            "whisper-diarization/temp_outputs",
            "htdemucs",
...
nemo_process = subprocess.Popen(
    ["python3", "whisper-diarization/nemo_process.py", "-a", vocal_target, "--device", args.device],
)
...
ROOT = os.getcwd()
temp_path = os.path.join(ROOT, "whisper-diarization/temp_outputs")
